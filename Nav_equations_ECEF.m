...
% Update attitude using (5.75)
 ...
 C_b_e =  old_C_b_e * C_new_old-Skew_symmetric([0,0,alpha_ie])*old_C_b_e;
%C_b_e=old_C_b_e*(eye(3)+Alpha_ib_b)-Skew_symmetric([0,0,alpha_ie])*old_C_b_e;
...
% UPDATE VELOCITY
% From (5.36),
a=f_ib_e + Gravity_ECEF_Complex(old_r_eb_e) -...
    2 * Skew_symmetric([0;0;omega_ie]) * old_v_eb_e;
if norm(a)<1
    a=zeros(3,1);
end
v_eb_e = old_v_eb_e + tor_i * a;
%Gravity_ECEF(old_r_eb_e)-Gravity_ECEF_Complex(old_r_eb_e)
...
% UPDATE VELOCITY
% From (5.36),
v_eb_e = old_v_eb_e + tor_i * (f_ib_e + Gravity_ECEF_Complex(old_r_eb_e) -...
    2 * Skew_symmetric([0;0;omega_ie]) * old_v_eb_e);
%Gravity_ECEF(old_r_eb_e)-Gravity_ECEF_Complex(old_r_eb_e)
