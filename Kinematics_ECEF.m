...
%
% Inputs:
%   tor_i         time interval between epochs (s) 间隔
%   C_b_e         body-to-ECEF-frame coordinate transformation matrix
%   载体到地心地固坐标系的转换矩阵
%   old_C_b_e     previous body-to-ECEF-frame coordinate transformation
%   matrix  前一时刻载体到地心地固坐标系的转换矩阵
%   v_eb_e        velocity of body frame w.r.t. ECEF frame, resolved along
%                 ECEF-frame axes (m/s) 载体在ECEF中的速度
%   old_v_eb_e    previous velocity of body frame w.r.t. ECEF frame, resolved
%                 along ECEF-frame axes (m/s) 前一历元 载体在ECEF中的速度
%   r_eb_e        Cartesian position of body frame w.r.t. ECEF frame, resolved
%                 along ECEF-frame axes (m)在ECEF中的笛卡尔坐标
% Outputs:
